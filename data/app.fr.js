const appEN = {
  ...
  contacts: {
    ...
    managers: {
      title: 'Gestionnaires',
      value: [
        { name: 'Ekaterina Pimchenko', pos: 'Responsable principal du commerce extérieur' },
        { name: 'Galina Lavitskaya', pos: 'Gestionnaire du commerce extérieur' },
        { name: 'Violetta Osmak', pos: 'Assistante Responsable Commerce Extérieur' },
      ],
    },
  ...
  content: {
    ...
    gallery: {
      ...
      imgs: [
        ...
        ['examples/example5.jpg', 'Isolation des murs extérieurs (façade humide) avec des plaques Beltermo'],
        ['examples/example6.jpg', 'Isolation sol et plafond'],
      ],
    },
  },
};
